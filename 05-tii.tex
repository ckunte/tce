...
\subsection{Effects of tourism on the economy} % (fold)
\label{sub:etoe}
...
\subsection{Social impact of tourism} % (fold)
\label{sub:simt}
...
\subsection{Ill effects of tourism} % (fold)
\label{sub:iet}
